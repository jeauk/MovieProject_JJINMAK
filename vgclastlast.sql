...
-- 테이블 데이터 vgc.joinup:~1 rows (대략적) 내보내기
DELETE FROM `joinup`;
...
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='영화예약';

-- 테이블 데이터 vgc.reservation:~24 rows (대략적) 내보내기
...
INSERT INTO `reservation` (`reservationId`, `location`, `hall`, `spot`, `date`, `starttime`, `endtime`, `userId`) VALUES
	...
	(53, '대구', '1관', '북구점', '2024-06-12', '05:00:00', '07:00:00', NULL),
	(54, '서울', '1관', '강남점', '2024-06-05', '05:00:00', '07:00:00', NULL),
	(55, '창원', '1관', '창원중앙점', '2024-06-06', '05:00:00', '07:00:00', NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='티켓팅';

-- 테이블 데이터 vgc.ticketing:~4 rows (대략적) 내보내기
...
INSERT INTO `ticketing` (`ticketingId`, `seat`, `price`, `reservationId`, `movieId`) VALUES
	...
	(40, 'F10', '10000', NULL, NULL),
	(41, 'F11', '10000', NULL, NULL);
